...
char  __attribute__((section (".data"))) fnamecopy [40];
__u8 __attribute__((section (".data"))) do_fat_read_block [2048];
...
long do_fat_read(const char *filename, void *buffer, unsigned long maxsize,
	...
	FAT_DPRINT ("FAT%d, fatlength: %d\n", mydata->fatsize,
			mydata->fatlength); FAT_DPRINT ("Rootdir begins at sector: %d, offset: %x, size: %d\n"
			"Data begins at: %d\n",
